...
module.exports = {
    ...
    updateUser: async(id, userinfo)=>{
        ...
        SET "CustomerName"='${userinfo.name}', "PhoneNumber"='${userinfo.phone_number}', "HomeAddress"='${userinfo.home_address}', "Email"='${userinfo.email_address}', "Username" = '${userinfo.username}'
    ...
    updateGGUser: async(id, userinfo)=>{
        const query = `UPDATE public."Customer"
        SET  "CustomerName"='${userinfo.name}', "PhoneNumber"='${userinfo.phone_number}', "HomeAddress"= '${userinfo.home_address}', "Username" = '${userinfo.username}'
        WHERE "CustomerID"='${id}' RETURNING "CustomerID";`
        const data = await  db.query(query);
        return data;
    },
